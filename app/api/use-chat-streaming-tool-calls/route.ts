    ...
    const result = await streamText({
        ...
        tools: {
            ...
            showWeatherInformation: {
                description: "Show the weather information to the user. Always use this tool to tell weather information to the user.",
                parameters: z.object({
                    city: z.string(),
                    weather: z.string(),
                    temperature: z.number(),
                    typicalWeather: z.string().describe("2-3 sentences about the typical weather in the city during spring."),
                }),
            },
        },
    });
