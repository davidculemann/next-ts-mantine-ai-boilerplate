...
export default function Chat() {
    const { status, messages, input, submitMessage, handleInputChange, error, stop } = useAssistant({ api: "/api/assistant" });
    ...
    return (
        <div className="flex flex-col w-full max-w-md py-24 mx-auto stretch">
            ...
            <button className="fixed bottom-0 w-full max-w-md p-2 mb-8 text-white bg-red-500 rounded-lg" onClick={stop}>
                Stop
            </button>
        </div>
    );
